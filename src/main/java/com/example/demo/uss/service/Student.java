...
public class Student {
    ...
    public Student(String userid, String passwd, String name, String birthday, String gender,
				   String regDate, String profileImage, int mgrNum) {
    	this.userid = userid;
    	this.passwd = passwd;
    	this.name = name;
	...
	@Builder
	private Student(String userid, String passwd, String name, String birthday,
					String regDate, String profileImage) {
		this.userid = userid;
		this.passwd = passwd;
		this.name = name;
		this.regDate = regDate;
